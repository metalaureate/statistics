...
## GET SWOON MESSAGE DATA
docs <- "/Users/shill/Desktop/SMM/feed.xml"
docdata<-xmlToDataFrame(docs) #my xml file
some_txt<-as.character(docdata$description[1:6000]) ##truncate
...
# classify emotion - anger, disgust, fear, joy, sadness, and surprise
...
ggplot(sent_df, aes(x=emotion)) +
  ...
  labs(x="emotion categories", y="number of conversations") +
  opts(title = "Sentiment Analysis of Conversations on Swoon\n(classification by emotion)",
